...
import { getWatchlist, removeFromWatchlist } from '@/app/actions/media'
                ...
                <div key={item.id} className="group relative">
                  ...
                  >
                    <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-secondary">
                      ...
                      {/* Type badge */}
                      <div className="absolute top-2 left-2 px-2 py-0.5 rounded bg-background/80 text-foreground text-xs font-medium capitalize">
                        {item.mediaType}
                      </div>
                    </div>
